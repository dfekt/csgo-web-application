...
var serverManagement  = function () {
    ...
    var consolelog_all = function(callback) {
        _get("/servers/console", callback)
    }
    ...
    var consolelog = function(server, callback) {
        _get(util.format("/servers/%s/console", server), callback)
    }
